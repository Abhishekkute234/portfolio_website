  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="w-full max-w-xl relative z-40 bg-transparent backdrop-blur-3xl p-6 sm:p-12 md:p-20 rounded-2xl border border-white/40 shadow-[0_20px_60px_rgb(0,0,0,0.05)]"
      >
