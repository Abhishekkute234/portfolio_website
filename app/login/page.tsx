...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[30%] left-[40%] w-[80vw] md:w-[40vw] h-[80vw] md:h-[40vw] rounded-full bg-[#DAEE47]/20 blur-[80px] md:blur-[100px] animate-pulse" style={{ animationDuration: '4s' }} />
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="w-full max-w-xl relative z-40 bg-transparent backdrop-blur-3xl p-6 sm:p-12 md:p-20 rounded-xl sm:rounded-2xl border border-white/40 shadow-[0_20px_60px_rgb(0,0,0,0.05)]"
      >
          ...
          <motion.div variants={itemVariants} className="pt-4 sm:pt-6">
            ...
            >
              ...
              {loading ? (
                ...
                <span className="relative z-10 tracking-widest uppercase text-[14px] font-bold">Sign In</span>
              )}
            </button>
          </motion.div>
        </form>
        ...
        <motion.div variants={itemVariants} className="mt-10 text-center">
          <p className="text-[#1A1A1A]/50 text-sm">
            ...
            <Link href="/register" className="text-[#1A1A1A] font-medium border-b border-[#1A1A1A] pb-[1px] hover:text-[#1A1A1A]/70 hover:border-[#1A1A1A]/70 transition-colors">
              Create one
            </Link>
          </p>
        </motion.div>
