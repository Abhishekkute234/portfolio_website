...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[30%] left-[40%] w-[40vw] h-[40vw] rounded-full bg-[#DAEE47]/20 blur-[100px] animate-pulse" style={{ animationDuration: '4s' }} />
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="w-full max-w-xl relative z-40 bg-transparent backdrop-blur-3xl p-12 sm:p-20 rounded-2xl border border-white/40 shadow-[0_20px_60px_rgb(0,0,0,0.05)]"
      >
